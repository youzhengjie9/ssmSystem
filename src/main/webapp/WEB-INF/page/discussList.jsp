...
<%--            $(this).parent().append("<div class='reply_textarea'><form method='post' action='resp'><textarea id='ta' name='response' cols='40' rows='5'></textarea><br/><input type='submit' value='回复'  /></form></div>");--%>
<%--        });--%>
<%--    });--%>
...
<div class="modal fade" id="myModal7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel7" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel7">发布讨论</h4>
            </div>
            <form method="post" action="${pageContext.request.contextPath}/discuss">
                <div class="modal-body">
                    标题：
                    <textarea id="textarea1" name="discussTitle" placeholder="请输入帖子标题" cols="60" rows="60"></textarea>
                    <br/>
                    <br/>
                请输入您想发布的讨论内容：<textarea name="discusscontent" id="textarea2" cols="90" rows="20" placeholder="请输入帖子内容"></textarea>
