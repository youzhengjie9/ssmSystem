          ...
          <ul class="pagination">
              <li>
                  <c:if test="${pageInfo.hasPreviousPage}">
                      <a href="${pageContext.request.contextPath}/toLogList/${pageInfo.pageNum-1}" aria-label="Previous">
...
<%--              pageInfo.navigatepageNums : 其实就是pageHelper帮你分好了的导航栏数字--%>
              <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                  <c:if test="${page!=pageInfo.pageNum}">
                      <li><a href="${pageContext.request.contextPath}/toLogList/${page}">${page}</a> </li>
                  </c:if>
                  <c:if test="${page==pageInfo.pageNum}">
                   <li class="active"><a  href="${pageContext.request.contextPath}/toLogList/${page}">${page}</a> </li>
               </c:if>
              ...
              <li>
                  ...
                  <c:if test="${pageInfo.hasNextPage}">
                      ...
                      <a href="${pageContext.request.contextPath}/toLogList/${pageInfo.pageNum+1}" aria-label="Next">
